...
public class Search {
    ...
    public static boolean linearSearchIsFound(int[] ints, int target) {
        for (int i = 0; i < ints.length; i++) {
            if (ints[i] == target) {
                return true;
            }
    ...
    public static int linearSearch(ArrayList<Integer> ints, int target) {
    ...
    // BE SURE TO USE EARLY RETURN
    public static int linearSearch(String[] strings, String target) {
    ...
    public static int linearSearchCount(int[] ints, int target) {
        int count = 0;
        for (int num : ints) {
            if (num == target) {
                count++;
    ...
    public static int linearSearchCount(ArrayList<Integer> integers, int target) {
        int count = 0;
